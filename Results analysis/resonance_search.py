...
def quick(nuclei1):#,nuclei2):
    """
    Calculates the expected critical angle of resonances based on R-matrix analysis data.

    Parameters:
    - nuclei1 (str): The nucleus whose resonance data is being analyzed.
...
def energy_levels(file_names,nucleus,bar_style='width',plot_thresholds=False,comparison='exp'):
    """
    Loads a list of resonance files and plots them, comparing them to a benchmark 
    defined by the <comparison> parameter.

    Parameters:
    - file_names (list of str): List of file names for .pkl dictionaries containing the resonance data.
    - nucleus (str): The nucleus being studied (e.g., '4H').
    - bar_style (str): Defines the meaning of the bar width. Use 'width' to signify the width of the state.
    - plot_thresholds (bool): Whether to plot threshold lines on the diagram.
    - comparison (str): The benchmark for comparison. It can be 'exp' for R-matrix analysis or a predefined spectrum 
                        from the paper_spectra function. Add dictionaries there to use different benchmarks.
...
def help():
    """
    Displays helpful information on how to use the resonance_search module, including function descriptions and an example usage.
    ...
    """
    print("""
==================== HELP: Resonance Search =====================

This script reads resonance data and plots energy levels diagrams. 
Provide the input in .pkl dictionaries. The file contains benchmark data 
from R-matrix analysis and other sources inside the code.

---------------------------------------------------------------
Example of Usage:
---------------------------------------------------------------
  python3 -c 'import resonance_search; resonance_search.energy_levels(
    ["resonances_1", "resonances_2"], "4H", "width", plot_thresholds=True, 
    comparison="Lazauskas_4H_N3LO")'
...
""")
    ...
    # List and display docstrings for the functions
    functions = [energy_levels, quick]
