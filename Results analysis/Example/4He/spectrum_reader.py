...
def help():
    print(" This is a code to read and visualize data from the manyeffv3b.f code.")
    print("Available functions are:")
    print("# Data manipulation:")
    print("\t1-readfiles(nucleus,prefix)\n\t2-load(nucleus)\n\t3-update(nucleus,prefix)\n\t4-remove_data(nucleus)")
    print("# Visualization:")
    print("\t1-plot_rotation(num_states)\n\t2-plot_convergence(state,parameter)\n\t3-track_state_rotation(num_states)\n\t4-check_existing_params(nucleus,simple=True)")
